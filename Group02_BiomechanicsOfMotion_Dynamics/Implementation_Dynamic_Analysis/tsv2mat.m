...
if strcmp(file,'gait')
    name_ori = 'trial0002_str2_f_';
elseif strcmp(file,'mountain_climber')
    name_ori = 'trial0010_mountain_climber_f_';
else
    name_ori = 'trial0001_static_frontal_f_';
end
