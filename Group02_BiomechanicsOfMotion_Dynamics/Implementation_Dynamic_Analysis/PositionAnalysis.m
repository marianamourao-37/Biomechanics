...
%global variables
global tol NR_MaxIter Flag 

%Initialize local parameters
i=0; % iteration counter
error=10.0*tol;  %estimated error at the start of Newton Raphson analysis
...
while (error>tol && i<=NR_MaxIter)
    i=i+1;
    
    %evaluate the constraints equations and jacobian matrix
    [Phi,Jac,~,~]=Kinem_FuncEval(q,time); 
