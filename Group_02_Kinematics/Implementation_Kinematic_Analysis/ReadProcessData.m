...
% first lines give informattion regarding the acquisition system. 
...
%% Filters the data 
marker_names = ["Head", "L Shoulder", "L Elbow", "L Wrist", "R Shoulder","R Elbow", ...
    "R Wrist", "L Hip", "L Knee", "L Ankle", "L Heel", "L Meta V","L Toe II", ...
    "R Hip", "R Knee", "R Ankle", "R Heel", "R Meta V", "R Toe II"];
